...
INSERT INTO COMPRA_ESPECIE
	VALUES (1, 1, 1, 1000, 500, 1000),
		...
		(6, 3, 1, 1000, 500, 1000),
		(7, 4, 2, 1000, 500, 1000),
		(8, 4, 3, 1000, 2000, 1000),
		(9, 5, 4, 1000, 500, 1000),
		(10, 5, 5, 1000, 500, 1000), 
		(11, 6, 1, 1000, 500, 1000),
		(12, 7, 2, 1000, 500, 1000),
		(13, 8, 3, 1000, 2000, 1000),
		(14, 9, 4, 1000, 500, 1000),
		(15, 10, 5, 1000, 500, 1000),
		(16, 11, 1, 1000, 500, 1000),
		(17, 12, 2, 1000, 500, 1000);
...
INSERT INTO VENTA(ID, FACTURA, FECHA, CLIENTE, USUARIO, INGRESO, KILO_TOTAL, DEVUELTA)
	VALUES (1, 'AA-001', NOW (), 1, 1, 50000, 200, FALSE),
		(2, 'AA-002', NOW (), 2, 1, 70000, 200, FALSE),
		(3, 'AA-003', NOW (), 3, 1, 55000, 200, FALSE),
		(4, 'AA-004', NOW (), 4, 1, 60000, 200, FALSE),
		(5, 'AA-005', NOW (), 5, 1, 100000, 200, FALSE),
		(6, 'AA-006', NOW (), 1, 1, 110000, 200, FALSE),
		(7, 'AA-007', NOW (), 2, 1, 100000, 200, FALSE),
		(8, 'AA-008', NOW (), 3, 1, 80000, 200, FALSE),
		(9, 'AA-009', NOW (), 4, 1, 115000, 200, FALSE),
		(10, 'AA-010', NOW (), 5, 1, 120000, 200, FALSE),
		(11, 'AA-011', NOW (), 1, 1, 125000, 200, FALSE),
		(12, 'AA-012', NOW (), 2, 1, 130000, 200, FALSE),
		(13, 'AA-013', NOW (), 3, 1, 50000, 200, FALSE),
		(14, 'AA-014', NOW (), 4, 1, 70000, 200, FALSE),
		(15, 'AA-015', NOW (), 5, 1, 55000, 200, FALSE),
		(16, 'AA-016', NOW (), 1, 1, 60000, 200, FALSE),
		(17, 'AA-017', NOW (), 2, 1, 100000, 200, FALSE),
		(18, 'AA-018', NOW (), 3, 1, 110000, 200, FALSE),
		(19, 'AA-019', NOW (), 4, 1, 100000, 200, FALSE),
		(20, 'AA-020', NOW(), 5, 1, 80000, 200, FALSE),
		(21, 'AA-021', NOW (), 1, 1, 115000, 200, FALSE),
		(22, 'AA-022', NOW (), 2, 1, 120000, 200, FALSE),
		(23, 'AA-023', NOW (), 3, 1, 125000, 200, FALSE),
		(24, 'AA-024', NOW (), 4, 1, 130000, 200, FALSE);
