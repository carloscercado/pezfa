...
values (1, 'CAPACIDAD', 80,50,'LA DISPONIBILIDAD DEL ESPACIO FÍSICO DE LOS ALMACENES SON EXITOSOS','LA DISPONIBILIDAD FÍSICA DE LOS ALMACENES SON MUY BAJA, REALIZAR MAS COMPRAS','MEJORAR LA DISPONIBILIDAD DEL ESPACIO FÍSICO DE LOS ALMACENES','MEDIR LA DISPONIBILIDAD DEL ESPACIO FÍSICO DE LOS ALMACENES'),
	...
	(6, 'ESPACIO DE LAS CAVAS', 60, 30, 'LA DISPONIBILIDAD DEL ESPACIO FÍSICO DE LA CAVA ES EXITOSO','LA DISPONIBILIDAD FÍSICA DE LA CAVA ES MUY BAJA, REALIZAR MAS COMPRAS','MEJORAR LA DISPONIBILIDAD DEL ESPACIO FÍSICO DE LAS CAVAS','MEDIR LA DISPONIBILIDAD DEL ESPACIO FÍSICO DE LAS CAVAS');
