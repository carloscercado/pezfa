...
values (1, 'CAPACIDAD', 80,50,'MENSAJE BUENO','MENSAJE MALO','MENSAJE ACEPTABLE','MEDIR LA CAPACIDAD DE CAVA'),
	(2, 'SATISFACCIÓN', 90,75, 'MENSAJE BUENO','MENSAJE MALO','MENSAJE ACEPTABLE','MEDIR LA SATISFACCIÓN DEL CLIENTE'),
	...
	(5, 'FORMACIÓN EMPLEADOS', 70,40, 'MENSAJE BUENO','MENSAJE MALO','MENSAJE ACEPTABLE','MEDIR LA FORMACIÓN DE LOS EMPLEADOS');
