...
public class AlmacenDB //registrar las funciones osea los crud de la base de datos
{
    public static boolean create(Almacen obj)
    {
    ...
    public static List<Almacen> read()
    {
       Session sesion = null;//
       ...
       try
       {
           ...
           lista=sesion.createQuery("from Almacen").list();//crea la consulta de la base de datos mediante el llamado de la clase y la muestra en forma de lista
    ...
    public static boolean update(Almacen obj)
    {
       Session sesion = null;
       boolean state = false;
       try
    ...
    public static boolean delete(Almacen obj)
    {
       Session sesion = null;
       boolean state = false;
       try
