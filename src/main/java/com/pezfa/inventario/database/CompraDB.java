...
public class CompraDB //registrar las funciones osea los crud de la base de datos
{
    public static boolean create(Compra obj)
    {
    ...
    public static List<Compra> read()
    {
       ...
       try
       {
           ...
           lista=sesion.createQuery("from Compra comprita join fetch comprita.proveedor join fetch comprita.usuario where comprita.estado = 'Comprado'").list();//crea la consulta de la base de datos mediante el llamado de la clase y la muestra en forma de lista
    ...
    public static boolean update(Compra obj)
    {
       Session sesion = null;
       boolean state = false;
       try
    ...
    public static boolean delete(Compra obj)
    {
       Session sesion = null;
       boolean state = false;
       try
