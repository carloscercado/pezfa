...
public class ClienteDB //registrar las funciones osea los crud de la base de datos
{
    ...
    public static List<Cliente> read()
    {
       ...
       try
       {
           ...
           lista=sesion.createQuery("from Cliente").list();//crea la consulta de la base de datos mediante el llamado de la clase y la muestra en forma de lista
