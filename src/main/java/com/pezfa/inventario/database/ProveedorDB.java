...
public class ProveedorDB //registrar las funciones osea los crud de la base de datos
{
    public static boolean create(Proveedor obj)
    {
    ...
    public static List<Proveedor> read()
    {
       ...
       try
       {
           ...
           lista=sesion.createQuery("from Proveedor").list();//crea la consulta de la base de datos mediante el llamado de la clase y la muestra en forma de lista
    ...
    public static boolean update(Proveedor obj)
    {
       Session sesion = null;
       boolean state = false;
       try
    ...
    public static boolean delete(Proveedor obj)
    {
       Session sesion = null;
       boolean state = false;
       try
