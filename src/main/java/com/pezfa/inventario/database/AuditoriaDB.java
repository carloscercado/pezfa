...
public class AuditoriaDB //registrar las funciones osea los crud de la base de datos
{
    public static boolean create(Auditoria obj)
    {
    ...
    public static List<Auditoria> read()
    {
       ...
       try
       {
           ...
           lista=sesion.createQuery("from Auditoria").list();//crea la consulta de la base de datos mediante el llamado de la clase y la muestra en forma de lista
    ...
    public static boolean update(Auditoria obj)
    {
       Session sesion = null;
       boolean state = false;
       try
    ...
    public static boolean delete(Auditoria obj)
    {
       Session sesion = null;
       boolean state = false;
       try
